...
/*
Update Notes:
1/6  - Changed time calculation from System.currentTimeMillis() to Instant with Duration.
     - Debugging adjusted minor things throughout the code, can see through the history.
     - Made personal path and tour calculation methods to avoid unwanted output.
*/
